...
public:
    ...
    bool send_ai_landing_start_auto();
    bool send_ai_landing_stop_auto();
    bool try_ai_landing_auto_start(const char *source);

    bool send_ai_vision_start(float mode, float stream, float freq_hz);
    bool send_ai_vision_stop();
    void check_ai_vision_ack_timeout(uint32_t now_ms);
...
private:
    ...
    */
    ...
    void update_ai_vision_timeout(void);
