...
public:
    ...
    enum {
        ...
        k_param__gcs,
        k_param_ailnd_strt_alt,
        k_param_ailnd_start_hz,
        k_param_ail_land_gimbal,
        k_param_ail_cam_x,
        k_param_ail_cam_y,
        k_param_ail_cam_z,
    ...
    // Epic 2.5: AI Landing auto stream parameters
    AP_Float ailnd_strt_alt;   // start altitude (m)
    AP_Int16 ailnd_start_hz;   // stream rate (Hz)
    AP_Int8 ail_land_gimbal;
    AP_Float ail_cam_x;
    AP_Float ail_cam_y;
    AP_Float ail_cam_z;
};
