...
const AP_Param::Info Plane::var_info[] = {
    ...
    // @Param: AILND_STRT_ALT
    // @DisplayName: AI landing start altitude
    // @Description: Altitude threshold in meters for automatically sending START_AI_LANDING during VTOL landing. If AGL is unavailable, relative home altitude is used.
    // @Units: m
    // @Range: 0 100
    // @Increment: 0.1
    // @User: Advanced
    GSCALAR(ailnd_strt_alt,         "AILND_STRT_ALT",   5.0f),

    // @Param: AILND_START_HZ
    // @DisplayName: AI landing stream rate
    // @Description: Requested AI landing stream rate in Hz when automatically sending START_AI_LANDING.
    // @Units: Hz
    // @Range: 1 50
    // @Increment: 1
    // @User: Advanced
    GSCALAR(ailnd_start_hz,         "AILND_START_HZ",   10),
    
    // @Param: AIL_LAND_GIMBAL
    // @DisplayName: AI Landing Gimbal Auto Pitch
    // @Description: Auto set gimbal pitch to -90 degrees when entering QLAND or QRTL.
    // @Values: 0:Disable,1:Enable
    // @User: Standard
    GSCALAR(ail_land_gimbal,         "AIL_LAND_GIMBAL",   1),

    // @Param: AIL_CAM_X
    // @DisplayName: AI camera mount offset X
    // @Description: Camera mount offset X relative to vehicle CG, in meters.
    // @Units: m
    // @Range: -10 10
    // @Increment: 0.01
    // @User: Advanced
    GSCALAR(ail_cam_x,              "AIL_CAM_X",         0.0f),

    // @Param: AIL_CAM_Y
    // @DisplayName: AI camera mount offset Y
    // @Description: Camera mount offset Y relative to vehicle CG, in meters.
    // @Units: m
    // @Range: -10 10
    // @Increment: 0.01
    // @User: Advanced
    GSCALAR(ail_cam_y,              "AIL_CAM_Y",         0.0f),

    // @Param: AIL_CAM_Z
    // @DisplayName: AI camera mount offset Z
    // @Description: Camera mount offset Z relative to vehicle CG, in meters.
    // @Units: m
    // @Range: -10 10
    // @Increment: 0.01
    // @User: Advanced
    GSCALAR(ail_cam_z,              "AIL_CAM_Z",         0.0f),
