...
#define MAVLINK_ARDUPILOTMEGA_XML_HASH 9076011295978052995
...
typedef enum MAV_CMD
{
   ...
   MAV_CMD_DO_SET_HOME=179, /* 
         ...
         |Use current location (MAV_BOOL_FALSE: use specified location). Values not equal to 0 or 1 are invalid.| Empty| Empty| Empty| Latitude| Longitude| Altitude|  */
...
#include "../flightstack/flightstack.h"
