/** @file
 *  @brief MAVLink comm protocol generated from flightstack.xml
 *  @see http://mavlink.org
 */
#pragma once
#ifndef MAVLINK_FLIGHTSTACK_H
#define MAVLINK_FLIGHTSTACK_H

#ifndef MAVLINK_H
    #error Wrong include order: MAVLINK_FLIGHTSTACK.H MUST NOT BE DIRECTLY USED. Include mavlink.h from the same directory instead or set ALL AND EVERY defines from MAVLINK.H manually accordingly, including the #define MAVLINK_H call.
#endif

#define MAVLINK_FLIGHTSTACK_XML_HASH 2389711227574791081
...
#define MAVLINK_MESSAGE_CRCS {{52100, 83, 38, 38, 0, 0, 0}, {52102, 125, 17, 17, 0, 0, 0}}
#endif

#include "../protocol.h"

#define MAVLINK_ENABLED_FLIGHTSTACK
...
typedef enum MAV_COMPONENT
{
   ...
   MAV_COMP_ID_UNICO_AI_COMPUTER=211, /* AI computer component | */
...
/** @brief  */
#ifndef HAVE_ENUM_AI_LANDING_FRAME
#define HAVE_ENUM_AI_LANDING_FRAME
typedef enum AI_LANDING_FRAME
{
   AI_LANDING_FRAME_CAMERA_FRD=200, /* Camera FRD frame | */
   AI_LANDING_FRAME_ENUM_END=201, /*  | */
} AI_LANDING_FRAME;
#endif
...
// MESSAGE DEFINITIONS
#include "./mavlink_msg_ai_landing_correction.h"
#include "./mavlink_msg_ai_landing_status.h"

// base include



#if MAVLINK_FLIGHTSTACK_XML_HASH == MAVLINK_PRIMARY_XML_HASH
# define MAVLINK_MESSAGE_INFO {MAVLINK_MESSAGE_INFO_AI_LANDING_CORRECTION, MAVLINK_MESSAGE_INFO_AI_LANDING_STATUS}
# define MAVLINK_MESSAGE_NAMES {{ "AI_LANDING_CORRECTION", 52100 }, { "AI_LANDING_STATUS", 52102 }}
